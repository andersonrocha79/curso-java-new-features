...
public class Java8LambdaExpression 
{
	...
	private static void exemplo01()
	{
		...
		{			
			...
			public void run() 
			{
				System.out.println("Thread 1 - com classe anônima...");
			}
		});
		...
		{			
			...
			public void run() 
			{
				System.out.println("Thread 2 - com classe anônima...");				
			}
		};
	...
	private static void exemplo02()
	{
		...
		{			
			...
			public void falar() 
			{
				System.out.println("Pessoa falando - com classe anônima");				
			}
		};		
		p1.falar();	
	...
	private static void exemplo03()
	{
		...
		{			
			...
			{
				System.out.println("Vendendo o produto - com classe anônima:\n" + p);	
				if (exibeTotal)
				{
					System.out.println("\nTotal: " + p.getTotal());
				}
